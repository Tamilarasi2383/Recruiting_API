<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_MailIdMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_MailIdMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <h5 class="font-weight-bolder">Mail Id</h5>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="row mt-4">
                            <div class="col-6">
                                <label class="form-label">Add Mail Id</label>
                                <div class="input-group">
                                    <input id="txtMailid" class="form-control" type="text" placeholder="Enter Mail Id" required="required" onblur="ValidateEmail('txtMailid');"/>
                                    <%----%>
                                </div>
                            ...
                            <div class="col-6 mt-4">
                                <button type="button" id="btnSave" class="btn bg-gradient-success mt-3 btn-resize" onclick="saveMailid();">Save</button>
                            </div>
                            </div>

                            <div class="mt-3"> 
                                <div class="col-md-12">
                                    <h6 class="font-weight-bolder">Mail Id List</h6>
                                </div>
                                ...
                                <div class="">
                                    <div class="col-md-12">
                                        ...
                                        <table class="table align-items-center mb-0" id="tblMaillist">
                                            <thead>
                                                <tr>
                                                    <th class="text-uppercase text-xxs font-weight-bolder opacity-7" style="color: black;">Mail Id</th>
    ...
    <script src="AppScripts/MailMaster.js"></script>
    ...
    <script>
     ...
     $(document).ready(function () {
            $("#txtSearch").on("keyup", function () {
                ...
                $("#tblMaillist tbody tr").filter(function () {
