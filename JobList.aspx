<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="Recruiting_API.JobList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid hidden">
                ...
                <div class="col-lg-5 col-sm-8">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            ...
                            <%-- <li class="nav-item" onclick="getJoblist('Feedback');" id="div_MyJobs">
                            <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="" role="tab" aria-selected="false" >My Jobs
                            </a>
                        </li>

                        
                        <li class="nav-item" onclick="getJoblist('Feedback');" id="div_Feedback">
                            <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="" role="tab" aria-selected="false" >Feedback
                            </a>
                        </li>--%>
                        </ul>
                    </div>
        ...
        <div class="container-fluid py-4">
            ...
            <%--<div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <div class="modal fade" id="loader" tabindex="-1" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog mt-lg-10" style="max-width: 500px;">
    ...
    <script src="AppScripts/Joblist.js"></script>
