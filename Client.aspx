<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Client.aspx.cs" Inherits="Recruiting_API.Client" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="text-sm mb-0">Create new Client</p>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" id="txtClientname" placeholder="Client Name" autocomplete="off" />
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <label>Client Type</label><span style="color: red;">*</span>
                                <select class="form-control" name="choices-sizes" id="drpClient">
                                    <option value="-1">--Select--</option>
                            ...
                            <div class="col-md-4">
                                <label>Place of Supply</label><span style="color: red;">*</span>
                                <select class="form-control" name="choices-sizes" id="drpPlaceofSupply">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-3 pt-0">
                                <div class="card-body pt-0 p-3">
                                    <table class="table align-items-center mb-0" id="tblCliConlist">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="color: black !important;">Recruiter Name</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="color: black !important;">Email</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="color: black !important;">Contact No</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="color: black !important;">Designation/Remarks</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="color: black !important;"></th>
                ...
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" id="btnBack" class="btn bg-gradient-secondary btn-resize" onclick="window.location.href='Clientlist.aspx'">Back</button>
                            </div>
                            <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
                                <button id="btnSave" type="button" class="btn bg-gradient-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2 btn-resize" onclick="ValidateClient() ">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog" style="max-width: 300px !important; margin-top: 15rem !important;">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer pt-0 text-center" style="border-top: none;">
                            <div class="col-md-12">
                                <button type="button" class="btn bg-gradient-primary mb-0 btn-resize" id="btnOk" onclick="window.location.href='Clientlist.aspx'">Ok</button>
                            </div>
                            <div class="col-md-12" >
                                <div class="row">
    ...
    <script src="AppScripts/Client.js"></script>
    <script>
