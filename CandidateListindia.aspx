<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="CandidateListindia.aspx.cs" Inherits="Recruiting_API.CandidateListindia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-10 col-sm-8">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        <li class="pe-5" onclick="window.location.href='CandidateOverviewIndia.aspx'" style="cursor:pointer;display:none;">
                            <a class="mb-0 px-0 py-1 " id="anchOverview"  data-bs-toggle="tab" role="tab" aria-selected="false">Today's Overview
                            </a>
                        </li>
                        <li class="pe-5" onclick="getcandidateList('All');" style="cursor:pointer;">
                            <a class="change_color  mb-0 px-0 py-1" id="anchCandidate"  data-bs-toggle="tab" role="tab" aria-selected="true">Candidate List
                            </a>
                        </li>
                  ...
                  <div class="w-100">
                    ...
                    <div class="card-footer pt-0 p-3 d-flex align-items-center">
                        ...
                        <div class="w-40 text-end">
                            <a class="btn bg-gradient-dark mb-0 text-end" href="CandidateIndia.aspx?id=NoJob">Add Candidates </a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="AppScripts/CandidateListindia.js"></script>
