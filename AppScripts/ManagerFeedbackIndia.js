...
$("#btnSave").click(function () {
    ...
    if (Validateweekinfo() == true) {
        ...
        common_api_ajax_request("api/TeamPerfomanceFeedbackIndia", "TEAMFEEDBACK", strdata);
...
function getRecruiterDetails(tileValue) {
    ...
    if (TWE_Id != "") {
        common_api_ajax_request("api/RecruiterDetailsListIndia", "RecruiterDetailsList", strdata);
    }
}

function getRecruiterJobDetails() {

    $("#div_total").addClass("colorchange");
    $("#div_interview").removeClass("colorchange");
    $("#div_jobcandidates").removeClass("colorchange");
    $("#div_closures").removeClass("colorchange");
    $("#lblTableheader").text("Total Jobs-Worked List");


    var TWE_Id = getSession('RecruiterID');

    var strdata = { "TWE_Id": TWE_Id, "Startdate": document.getElementById("hdnstartdate").value, "Enddate": document.getElementById("hdnenddate").value };
    if (TWE_Id != "") {
        common_api_ajax_request("api/RecruiterJobListIndia", "RecruiterJobList", strdata);
    }
