$(document).ready(function () {
    ...
    //$('#txtBIDate').val(today.getFullYear() + '-' + ('0' + (today.getMonth() + 1)).slice(-2) + '-' + ('0' + today.getDate()).slice(-2));
    //$('#txtBIDate').val(today.getFullYear() + '-' + ('0' + (today.getMonth() + 1)).slice(-2) + '-' + ('0' + today.getDate()).slice(-2));
    stopLoader();
});
...
function getcandidateProfile(candVal, JobVal) {
    ...
    if (TWE_Id != "") {
        common_api_ajax_request("api/FeedbackPageLoadIndia", "CANDPROFILEFEEDBACK", strdata);
    }
}
...
function getcandidateFeedback(JobVal) {
    ...
    if (TWE_Id != "") {
        common_api_ajax_request("api/CandidateCommentsIndia", "CANDFEEDBACK", strdata);
    }
}
...
function feedback(sdata) {
    ...
    $('#p_Reccommdate').text(sdata.createdOn + "|" + sdata.createdTime + " IST");
    ...
    $('#p_TLcommdate').text(sdata.TLcomgivenon + "|" + sdata.TLcomgiventime + " IST");
...
function saveCandComments() {
    ...
    if (validateFeedback() == true) {
        ...
        common_api_ajax_request("api/saveCandidateCommentsIndia", "SAVECANDCOMMENT", strdata);
    }
}
