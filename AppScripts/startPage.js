    ...
    if ((getSession('TWE_ID')) == undefined) {
        ...
        if (getSession("RegionValue") == "2000") {
            ...
            if (getSession('Designation') == "4001") {
                document.getElementById("jobList").href = "JobListindia.aspx";
                document.getElementById("anchPerf").href = "ManagerFeedbackpageIndia.aspx?id=" + getSession('RecruiterID') + "&name=" + getSession('Name').replace(" ", "%20");
                ...
                document.getElementById("jobList").href = "ManagerJobListindia.aspx";
            ...
            if (getSession('Designation') == "4001") {
                document.getElementById("jobList").href = "JobList.aspx";
                document.getElementById("anchPerf").href = "ManagerFeedbackpage.aspx?id=" + getSession('RecruiterID') + "&name=" + getSession('Name').replace(" ", "%20");
                $('#li_perf').css('display', 'block');
            }
            else if (getSession('Designation') == "4000" || getSession('Rolename') == "Manager" || getSession('Rolename') == "Senior Manager") {
                document.getElementById("jobList").href = "ManagerJobList.aspx";
                $('#li_team').css('display', 'block');
            }
