...
function getJoblist(tileValue) {
    if (tileValue == "Pipeline") {
    ...
    else if (tileValue == "Follow Up" || tileValue == "Feedback" || tileValue == "MyJobs") {
        ...
        if (tileValue == "Feedback") {
            ...
            $("#anchFollowup").removeClass("change_color");
            $("#anchSelfcreatedjob").removeClass("change_color");
            $("#anchFeedback").addClass("change_color");

        }
        else if (tileValue == "MyJobs") {
            strTile = "MyJobs";
            $("#anchOverview").removeClass("change_color");
            $("#anchFollowup").removeClass("change_color");
            $("#anchSelfcreatedjob").addClass("change_color");
            $("#anchFeedback").removeClass("change_color");

        }
        else if (tileValue == "Follow Up") {
            $("#anchOverview").removeClass("change_color");
...
//        } else {
//            strTable += "<tr style='cursor:pointer;'><td onclick=gotojobpage('" + item.Jobcode +"');><div class='d-flex px-2 py-1'>" +
...
function createJobTable(data) {
    ...
    $.each(data, function (key, item) {
        ...
        if (item.Jobcode == "") {
            ...
            //    if (getSession('JobFeedback') == "2" || (getSession('JobFeedback') == "1" && getSession('TWE_ID') == item.AssignTo))
            //        strTable += "<td class='align-middle'><div class='col-lg-3 col-1 my-auto text-end'>" +
            //            "<div class='dropdown float-lg-end pe-1'>" +
            //            "<a class='cursor-pointer' id='dropdownTable' data-bs-toggle='dropdown' aria-expanded='false'>" +
            //            "<i class='fa fa-ellipsis-v text-secondary'></i> </a>" +
            ...
            //alert(getSession('TWE_ID') + "==" + item.AssignTo);
            ...
            //if ((getSession('JobView') == "2" && getSession('JobEdit') == "2") || (getSession('JobView') == "1" && getSession('JobEdit') == "1")) {
            //    strTable += "<td class='align-middle'><div class='col-lg-3 col-1 my-auto text-end'>" +
            //        "<div class='dropdown float-lg-end pe-1'>" +
            //        "<a class='cursor-pointer' id='dropdownTable' data-bs-toggle='dropdown' aria-expanded='false'>" +
            //        "<i class='fa fa-ellipsis-v text-secondary'></i> </a>" +
            ...
            //        "</ul></div></div></td></tr>";
            //}
            //else if (getSession('JobView') == "2" && getSession('JobEdit') == "1") {
            //    if (assigneduser == true) {
            //        strTable += "<td class='align-middle'><div class='col-lg-3 col-1 my-auto text-end'>" +
            //            "<div class='dropdown float-lg-end pe-1'>" +
            //            "<a class='cursor-pointer' id='dropdownTable' data-bs-toggle='dropdown' aria-expanded='false'>" +
            ...
            //    }
            //}
            //else if (getSession('JobView') == "1" && getSession('JobEdit') == "2") {
            //    if (assigneduser == true) {
            //        strTable += "<td class='align-middle'><div class='col-lg-3 col-1 my-auto text-end'>" +
            //            "<div class='dropdown float-lg-end pe-1'>" +
            //            "<a class='cursor-pointer' id='dropdownTable' data-bs-toggle='dropdown' aria-expanded='false'>" +
