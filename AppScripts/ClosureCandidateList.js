...
function getClosureList() {
    ...
    if (TWE_Id != "") {
        common_api_ajax_request("api/CandidateClosureList", "CLOSURELIST", strdata);
    }
}
...
function createCandTable(data) {
    ...
    $.each(data, function (key, item) {
        if (item.Jobcode == "") {
            ...
            var strCandTable = "<li><a class='dropdown-item border-radius-md' href='Candidate.aspx?id=" + item.jobcode + "&jobId=" + item.candidateid + "' id='Edit'>Edit</a></li>";
