...
$(document).ready(function () {
    ...
    setSession("Page", "CandidateListIndia");
...
function createCandTable(data) {
    ...
    $.each(data, function (key, item) {
        if (item.Jobcode == "") {
            ...
            var strCandTable;
            if (item.jobcode == "") {
                strCandTable = "<li><a class='dropdown-item border-radius-md' href='CandidateIndia.aspx?id=" + item.candidateid + "' id='Edit'>Edit</a></li>";
            }
            else {
                strCandTable = "<li><a class='dropdown-item border-radius-md' href='CandidateIndia.aspx?id=" + item.jobcode + "&jobId=" + item.candidateid + "' id='Edit'>Edit</a></li>";
            }
            ...
            if (filterType == "Follow") {
                ...
                strTable += "<td class='align-middle'><div class='col-lg-3 col-1 my-auto text-end'>" +
                    ...
                    //"<li><a class='dropdown-item border-radius-md' href='Candidate_Viewindia.aspx?id=" + item.candidateid + "&jobId=" + item.jobcode + "' id='View'>View</a></li>" +
                    "<li><a class='dropdown-item border-radius-md' href='Candidate_Viewindia.aspx?id=" + item.candidateid + "' id='View'>View</a></li>" +
                    "<li><a class='dropdown-item border-radius-md' href='CandidateIndia.aspx?id=" + item.jobcode + "&jobId=" + item.candidateid + "' id='Edit'>Edit</a></li>" +
                    "</ul></div></div></td></tr>";
