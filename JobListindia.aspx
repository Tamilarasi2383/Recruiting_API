<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="JobListindia.aspx.cs" Inherits="Recruiting_API.JobListindia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid hidden">
                    ...
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="pe-5" onclick="getJoblist('Open');">
                                <a class="mb-0 px-0 py-1" id="anchOverview" data-bs-toggle="tab" href="" role="tab" aria-selected="true">Overview
                                </a>
                            </li>

                            <li class="pe-5" onclick="getJoblist('Follow Up');">
                                <a class="mb-0 px-0 py-1" id="anchFollowup" data-bs-toggle="tab" href="" role="tab" aria-selected="false">Follow Up
                                </a>
                            </li>

                            <%--<li class="pe-5" onclick="getJoblist('MyJobs');" id="div_MyJobs">
                            <a class="mb-0 px-0 py-1 " id="anchSelfcreatedjob" data-bs-toggle="tab" href="" role="tab" aria-selected="false" >Self Created Jobs
                            </a>
                        </li>
                        
                        <li class="pe-5" onclick="getJoblist('Feedback');" id="div_Feedback">
                            <a class="mb-0 px-0 py-1 " id="anchFeedback" data-bs-toggle="tab" href="" role="tab" aria-selected="false" >Feedback
                            </a>
                        </li>--%>
                        </ul>
                    </div>
        ...
        <div class="container-fluid py-4">
            ...
            <div class="row" id="div_tile">
                <div class="col-lg-8 col-12">
                    <div class="row">
                        <div class="col-lg-4 col-12 zm" style="box-shadow: none;">
                            <div id="div_open" class="card card-background h-100 tilt" data-tilt="" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0">
                            <div class="card zm colorchange" id="div_pipeline" onclick="getJoblist('Pipeline');">
                                <div class="card-body p-3">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold"><span id="lblPipelineus">Pipeline</span></p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="lblPipelinevalueus"></span>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0">
                            <div class="card zm colorchange" id="div_highpriority" onclick="getJoblist('High Priority');">
                                <div class="card-body p-3">
                                    <div class="d-flex">
                                        <div>
                                            <div class="icon icon-shape bg-gradient-dark text-center border-radius-md">
                                        ...
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold"><span id="lblHighpriorityus">High Priority</span></p>
                                                <h5 class="font-weight-bolder mb-0">
                                                    <span id="lblHighpriorityvalueus"></span>
                ...
                <div class="col-lg-4 col-12 mt-4 mt-lg-0">
                    <div class="col-xl-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card zm colorchange" id="div_Total" onclick="getJoblist('Total');">
                                    ...
                                    <div class="card-body pt-0 p-3 text-center">
                                        <h6 class="text-center mb-0"><span id="lblTotaljobsus">Total Jobs</span></h6>
                        ...
                        <div class="d-lg-flex">
                            ...
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <button type="button" id="btnNewJob" class="btn bg-gradient-primary btn-sm mb-0" onclick="window.location='AddJobcode_Ind.aspx'">
                                        +&nbsp; New  Job
                                    </button>
    ...
    <script src="AppScripts/JoblistIndia.js"></script>
