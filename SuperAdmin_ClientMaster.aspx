<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="SuperAdmin_ClientMaster.aspx.cs" Inherits="Recruiting_API.SuperAdmin_ClientMaster" %>
            ...
            <div class="col-md-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12" style="margin-top: -10px;">
                                    ...
                                    <label id="lblCreatedby">Prasanna Murugaiyan</label>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body p-3 pt-0">
                                ...
                                <div class="col-md-12">
                                    <label>Email</label>
                                    <input class="form-control" type="text" id="txtEmail" placeholder="Email" autocomplete="off" />
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <label>Designation/Remarks</label>
                            ...
                            <div class="card-body p-3 pt-0">
                                <div class="card-body pt-0 p-3">
                                    <table class="table align-items-center mb-0" id="tblVenConlist">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 pt-0" style="color: black !important;">Recruiter Name</th>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 pt-0 ps-2 text-right" style="color: black !important; padding-right: 0px;">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
                ...
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" id="btnBack" class="btn bg-gradient-secondary btn-resize" onclick="window.location.href='JobList.aspx'">Back</button>
                            </div>
