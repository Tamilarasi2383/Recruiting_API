<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_RoleMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_RoleMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <h5 class="font-weight-bolder">Role</h5>
                    </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="txtAddrole" class="form-control" type="text" placeholder="Add Role" required="required"/>
                                    <%----%>
                                </div>
                            ...
                            <div class="col-6 mt-4">
                                <button type="button" id="btnSave" class="btn bg-gradient-success mt-3 btn-resize" onclick="saveRolenid();">Save</button>
                            </div>
                        </div>

                        <div class="mt-3"> 
                                <div class="col-md-12">
                                    <h6 class="font-weight-bolder">Role List</h6>
                                </div>
   ...
   <link href="assets/css/soft-ui-dashboard-pro.css" rel="stylesheet" />
    ...
    <script src="AppScripts/RoleMaster.js"></script>
