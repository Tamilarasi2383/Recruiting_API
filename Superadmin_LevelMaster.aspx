<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_LevelMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_LevelMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <h5 class="font-weight-bolder">Level</h5>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="row mt-4">
                            <div class="col-6">
                                <label class="form-label">Add Level</label>
                                <div class="input-group">
                                    <input id="txtAddlevel" class="form-control" type="text" placeholder="Add Level" required="required"/>
                                    <%----%>
                                </div>
                        ...
                        <div class="mt-3"> 
                                <div class="col-md-12">
                                    <h6 class="font-weight-bolder">Level List</h6>
                                </div>
                                ...
                                <div class="">
                                    <div class="col-md-12">
                                        ...
                                        <table class="table align-items-center mb-0" id="tblCreation">
                                            <thead>
                                                <tr>
                                                    <th class="text-uppercase text-xxs font-weight-bolder opacity-7" style="color: black;">Level Name</th>
    ...
    <script src="AppScripts/LevelMaster.js"></script>
