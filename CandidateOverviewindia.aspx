<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="CandidateOverviewindia.aspx.cs" Inherits="Recruiting_API.CandidateOverviewindia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-4 col-sm-8">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        <li class="pe-5" >
                            <a class="change_color mb-0 px-0 py-1"  data-bs-toggle="tab" href="#" role="tab" aria-selected="true">Today's Overview
                            </a>
                        </li>
                        <li class="pe-5" onclick="window.location.href='CandidateListindia.aspx'" style="cursor:pointer;display:none;">
                            <a class="mb-0 px-0 py-1"  data-bs-toggle="tab" role="tab" aria-selected="false">Candidate List
                            </a>
                        </li>
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <a class="btn bg-gradient-dark mb-0" href="CandidateIndia.aspx?id=NoJob"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Candidate</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="assets/js/jquery.js"></script>
        ...
        <script src="AppScripts/CandidateOverviewindia.js"></script>
