<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Vendorlist.aspx.cs" Inherits="Recruiting_API.Vendorlist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="col-lg-6 text-right">
                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                        <div class="ms-auto my-auto">
                            <button type="button" id="btnAdd" class="btn bg-gradient-primary btn-sm mb-0" onclick="window.location='Vendor.aspx'" style="float: right;">
                                +&nbsp; Add Vendor
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-6 d-flex align-items-center">
                                <h5 class="ms-3"><span id="lblTableheader">Vendor List</span></h5>
                            </div>
                        ...
                        <table class="table align-items-center mb-0" id="tblVendorlist">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Recruiters</th>
    ...
    <script src="AppScripts/Vendorlist.js"></script>
