<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_RegionMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_RegionMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <h5 class="font-weight-bolder">Region</h5>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="row mt-4">
                            <div class="col-6">
                                <label class="form-label">Add Region</label>
                                <div class="input-group">
                                    <input id="txtAddregion" class="form-control" type="text" placeholder="Add Region" required="required"/>
                                    <%----%>
                                </div>
                            ...
                            <div class="col-6 mt-4">
                                <button type="button" id="btnSave" class="btn bg-gradient-success mt-3 btn-resize" onclick="saveRegionid();">Save</button>
                            </div>

                            <div>
                                <div class="col-md-12">
                                    <h6 class="font-weight-bolder">Region List</h6>
                                </div>
                                ...
                                <div class="">
                                    <div class="col-md-12">
                                        ...
                                        <table class="table align-items-center mb-0" id="tblCreation">
                                            <thead>
                                                <tr>
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="color: black !important;">Region Name</th>
    ...
    <script src="AppScripts/RegionMaster.js"></script>
