<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_MenuListMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_MenuListMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="mt-3">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="font-weight-bolder">Menu List</h5>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <button type="button" id="btnAddtarget" class="btn bg-gradient-primary btn-sm mb-0" onclick="window.location='Superadmin_MenuMaster.aspx'">
                                            +&nbsp; Add Menu
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                <div class="col-md-12">
                                    ...
                                    <table class="table align-items-center mb-0" id="tblMenulist">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-xxs font-weight-bolder opacity-7" style="color: black;">Menu Name</th>
    ...
    <script src="AppScripts/MenuList.js"></script>
