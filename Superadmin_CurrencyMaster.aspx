<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_CurrencyMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_CurrencyMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <h5 class="font-weight-bolder">Currency</h5>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="row mt-4">
                            <div class="col-6">
                                <label class="form-label">Add Currency Type</label>
                                <div class="input-group">
                                    <input id="txtCurrencytype" class="form-control" type="text" placeholder="Add Currency Type" required="required" />
                                </div>
                        ...
                        <div class="mt-3">
                            <div class="col-md-12">
                                <h6 class="font-weight-bolder">Currency Type List</h6>
                            </div>
                            ...
                            <div class="">
                                <div class="col-md-12">
                                    ...
                                    <table class="table align-items-center mb-0" id="tblCreation">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-xxs font-weight-bolder opacity-7" style="color: black;">Currency Name</th>
    ...
    <script src="AppScripts/CurrencyMaster.js"></script>
