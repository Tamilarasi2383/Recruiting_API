<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Candidate_Viewindia.aspx.cs" Inherits="Recruiting_API.Candidate_Viewindia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                            <i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Profile" onclick="onclick=gotoEditCandiate();"></i>
                        </a>
                    </div>
                </div>
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1"><span id="lblCandidatename"></span>
                        </h5>
            ...
            <div class="row">
                <div class="col-12 col-xl-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark"><span>Candidate Name:</span></strong> &nbsp;<input type="hidden" id="hdncandid" /> <span id="lblCandcandidatename"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Mobile:</span></strong> &nbsp; <span id="lblCandmobile"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Email:</span></strong> &nbsp; <span id="lblCandemail"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Location:</span></strong> &nbsp; <span id="lblCandlocation"></span></li>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark"><span>Employer Name:</span></strong> &nbsp; <span id="lblEmpemployername"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Mobile:</span></strong> &nbsp; <span id="lblEmpmobile"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Email:</span></strong> &nbsp; <span id="lblEmpemail"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Corporation:</span></strong> &nbsp; <span id="lblEmpcorporation"></span></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark"><span>Location:</span></strong> &nbsp; <span id="lblEmplocation"></span></li>
                                
                            </ul>
                            <hr class="horizontal gray-light my-4">
                            <ul class="list-group">
                            <li class="list-group-item border-0 ps-0 text-sm mb-1"><strong class="text-dark">Specialization</strong>
                                <p id="lblEmpspecialization"></p>
                            </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card h-100">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">Matching Jobs</h6>
                        </div>
                        <div class="card-body p-3" id="div-matchjobs" style="overflow: scroll;overflow-x: hidden;height: 100px;">
                            <ul class='list-group'><li class='list-group-item border-0 d-flex align-items-center px-0 mb-2'><div class='avatar me-3'><img src='Images/Sap_logo.png' class='avatar avatar-sm me-3'></div><div class='d-flex align-items-start flex-column justify-content-center'><div class='d-flex flex-column justify-content-center'><label class='mb-0 text-sm h6' id='lblJobname'></label><label class='mb-0'><label class='text-xs' id='lblJobmonth'></label>|<label class='text-xs' id='lblJobcontract'></label>|<label class='text-xs' id='lblJobcity'></label></label></div></div><a class='btn btn-link pe-3 ps-0 mb-0 ms-auto' href='javascript:;'>Apply</a></li></ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-body d-flex" id="div_proof" style="background:transparent;box-shadow:none !important;">
                <div class="card-body d-flex">
                    <div class="col-lg-1 col-md-2 col-sm-3 col-4 text-center">
                        ...
                        <p class="mb-0 text-sm"><span id="lblResume">Resume</span></p>
                    </div>
                    <div class="col-lg-1 col-md-2 col-sm-3 col-4 text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Created on
                                                        <br />
                                                        <span id="lblEccreatedondate"></span> | <span id="lblECscreatedontime"></span> IST</p>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Updated on
                                                        <br />
                                                        <span id="lblECupdatedondate"></span> | <span id="lblEcupdatedontime"></span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Created on
                                                        <br />
                                                        <span id="lblEcintcreatedondate"></span> | <span id="lblEcintcreatedontime"></span> IST</p>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Updated on
                                                        <br />
                                                        <span id="lblEcintupdatedondate"></span> | <span id="lblEcintpdatedontime"></span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="div_BPcre" style="display: none;">Created on
                                                        <br />
                                                        <span id="lblBpcreatedondate"></span> | <span id="lblBpscreatedontime"></span> IST</p>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="div_BPupd" style="display: none;">Updated on
                                                        <br />
                                                        <span id="lblBpupdatedondate"></span> | <span id="lblBpupdatedontime"></span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="div_BPIcre" style="display: none;">Created on
                                                        <br />
                                                        <span id="lblBpintcreatedondate"></span> | <span id="lblBpintscreatedontime"></span> IST</p>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="div_BPIupd" style="display: none;">Updated on
                                                        <br />
                                                        <span id="lblBpintupdatedondate"></span> | <span id="lblBpintupdatedontime"></span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="row">
                                                <div class="col-6 text-left" id="div_TLcre" style="display: none;">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Created on
                                                        <br />
                                                        <span id="lblTlcommentscreatedondate"></span> | <span id="lblTlcommentscreatedontime"></span> IST</p>
                                                </div>
                                                <div class="col-6 text-right" id="div_TLupd" style="display: none;">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Updated on
                                                        <br />
                                                        <span id="lblTlcommentsupdatedondate"></span> | <span id="lblTlcommentsupdatedontime"></span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Created on
                                                        <br />
                                                        <span id="lblRecrutiercreatedate"></span> | <span id="lblRecrutiercreatedontime"></span> EST</p>
                                                </div>
                                                <div class="col-6 text-right" id="div_Recupd" style="display: none;">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Updated on
                                                        <br />
                                                        <span id="lblRecrutierupdatedondate"></span> | <span id="lblRecrutierupdatedontime"></span> EST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="AppScripts/Candidate_Viewindia.js"></script>
    <script>
        $("#drpJobtitle").select2();
    ...
    $.ajax({
        type: "POST",
        url: "Candidate_Viewindia.aspx/DownloadFile",
    ...
    <script type="text/javascript">
        function DownloadFile(t) {
            ...
            var lbl = t.id;
            //Set the File URL.
            var fileName = $("#" + lbl).text();

            //fileName = "Ushashree_ETL_Talend.docx";
            if (lbl.includes("Resume")) {
                url = "Candidate/Resume_India/" + fileName;
            }
            else if (lbl.includes("Aadhar")) {
                url = "Candidate/Aadhar_India/" + fileName;
            }
            else if (lbl.includes("PAN")) {
                url = "Candidate/PAN_India/" + fileName;
            }
            else if (lbl.includes("Other")) {
                url = "Candidate/OtherDocuments_India/" + fileName;
            }
