<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="RecruiterDashboard_Ind.aspx.cs" Inherits="Recruiting_API.RecruiterDashboard_Ind" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid py-4 ">
        ...
        <div class="row">
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card zm" id="div_Job" onclick="gotoJobPage();" style="cursor: pointer;">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card zm" style="cursor: pointer;" onclick="window.location.href='CandidateListindia.aspx'">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card zm" style="cursor: pointer;" onclick="window.location.href='ClosureCandidateListIndia.aspx'">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" id="anchCheck" href="javascript:;">Check List
                ...
                <div class="card h-100 p-3">
                    <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('assets/img/ivancik.jpg');">
                        ...
                        <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                            <h5 class="text-white font-weight-bolder mb-4 pt-2">IST Time |
                            ...
                            <table class="text-white">
                                ...
                                <tr>
                                    <td>
                                        <label class="h6 head-tag text-white" id="lblIst">05.00 AM</label></td>
                                </tr>
                            </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-5 text-end">
                                <div class="dropdown float-lg-end pe-4">
                                    <a id="dropdownTable" style="color: dodgerblue; cursor: pointer !important;" href="JobListindia.aspx">View All
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline timeline-one-side">
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblECTitle"></span></h6>
                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><span id="lblECClosures"></span></p>
                                </div>
                            </div>
                            <div class="timeline-block mb-3">
                                <span class="timeline-step">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblBPTitle"></span></h6>
                            ...
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblTLTitle"></span></h6>
                            ...
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblSBTitle"></span></h6>
                            ...
                            <%--<div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblVenTitle"></span></h6>
                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><span id="lblVendors"></span></p>
                                </div>
                            </div>--%>
                            <div class="timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0"><span id="lblCanTitle"></span></h6>
                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><span id="lblCandidates"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="AppScripts/dashboardIndia.js"></script>    
