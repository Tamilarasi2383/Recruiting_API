<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="RecruiterPerformanceIndia.aspx.cs" Inherits="Recruiting_API.RecruiterPerformanceIndia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        ...
        .active-label {
            ...
            /*margin-top: 20px;*/
            border-bottom: 3px solid #3dc0f9;
        }

        .week-color-green{
                border: solid 2px #55ff55;
        }

        .week-color-blue{
                border: solid 2px #3017ff;
        }
                    ...
                    <div class="col-md-12 text-center card p-3" style="height:341px;">
                        <div class="card-header pb-0 p-3">
                            <div class="d-flex justify-content-between">
                                <h6 class="mb-0">Performance Indicator <span class="h6" id="lblduration"></span></h6>
                        ...
                        <div class="card-body p-3">
                          <div class="row">
                            <div class="col-12 text-center">
                              <div class="chart" id="divDoughchart">
...
<%--                                <span class="d-block text-body text-sm">WATTS</span>--%>
    ...
    <script src="AppScripts/RecruiterFeedbackIndia.js"></script>
</asp:Content>
