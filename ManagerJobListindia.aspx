<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="ManagerJobListindia.aspx.cs" Inherits="Recruiting_API.ManagerJobListindia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="pe-5" onclick="getJoblist('Open','');">
                                <a class="change_color mb-0 px-0 py-1 active " id="anchOverview" data-bs-toggle="tab" href="" role="tab" aria-selected="true">Overview
                                </a>
                            </li>
        ...
        <div class="mt-4">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="col-md-12 text-center" id="div_norecord" style="display:none;">
                        <img src="Images/No Records Found.png" style="width: 500px; height: 500px;" />
                    </div>

                    <div class="" id="div_record" style="display:none;">
                        ...
                        <table class="table align-items-center mb-0 mt-3" id="tblJoblist">
                            <thead>
                                <tr>
                        ...
                        <%--<div class="dataTable-bottom">
                            ...
                            <div id="paginus" class="pagination pagination-info">
                                ...
                                <div id="div_next" class="next"><i class='ni ni-bold-right' aria-hidden='true'></i></div>
                            </div>
                        </div>--%>
    ...
    <script src="AppScripts/ManagerJobListIndia.js"></script>
