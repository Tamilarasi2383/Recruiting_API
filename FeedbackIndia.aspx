<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="FeedbackIndia.aspx.cs" Inherits="Recruiting_API.FeedbackIndia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="card-body p-3 pt-0">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <p class="text-sm mb-3 mt-2">Created By <span id="lblCreateby"></span> | <span id="lblCreateon"></span> - <span id="lblCreatetime"></span> IST</p>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 my-auto text-end">
                                    <a href="javascript:;"><span class="badge badge-sm bg-gradient-success" id="lblStatus" style="padding: 10px;cursor: not-allowed;"></span></a>
                                    <h6 class="text-lg mb-0 mt-2">
                                        <img src="Images/in-rupee.png" width="15" height="15" /><span id="lblRate" ></span> on <span id="lblType2"></span></h6>
                                    ...
                                    <div class="timeline timeline-one-side">
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="p_ECIcommdate" style="display: none;">28 JUN 2021 | 03:00PM IST</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0" id="p_BPIcommdate" style="display: none;">28 JUN 2021 | 03:00PM IST</p>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row" style="margin-top: -20px;">
                                                        <div class="col-md-6">
                                                            ...
                                                            <%--<input class="form-control datepicker" type="text" placeholder="Select Date" id="txtdateec" disabled="disabled">--%>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                              <input class="form-check-input" type="radio" name="flexRadioDefault3" id="radBPApp" onclick="getstatusfeedback('radBPApp', 'txtBPComments')">
                                                              <label class="custom-control-label" style="color:green" for="customRadio2">Approve</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                              <input class="form-check-input" type="radio" name="flexRadioDefault3" id="radBPRej" onclick="getstatusfeedback('radBPRej', 'txtBPComments')">
                                                              <label class="custom-control-label text-danger" for="customRadio2">Reject</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row" style="margin-top: -20px;">
                                                        <div class="col-md-6">
                                                            <label class="">Interview Date</label>
                                                            <%--<input class="form-control datepicker" type="text" placeholder="Select Date" id="txtBIDate" disabled="disabled" />--%>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="row">
                                                <div class="col-6 text-left">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Created on
                                                        <br />
                                                        <span id="lblRecrutiercreatedate">01 Jun 2021</span> | <span id="lblRecrutiercreatedontime">06.15 PM</span> IST</p>
                                                </div>
                                                <div class="col-6 text-right" id="div_Recupd" style="display: none;">
                                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Updated on
                                                        <br />
                                                        <span id="lblRecrutierupdatedondate">01 Jun 2021</span> | <span id="lblRecrutierupdatedontime">06.15 PM</span> IST</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="AppScripts/FeedbackIndia.js"></script>
