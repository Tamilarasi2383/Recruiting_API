<%@ Page Title="" Language="C#" MasterPageFile="~/RecruitingApp.Master" AutoEventWireup="true" CodeBehind="Superadmin_TargetListMaster.aspx.cs" Inherits="Recruiting_API.Superadmin_TargetListMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body" id="profile">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="font-weight-bolder">Target</h5>
                            </div>
                            <div class="col-md-6 text-right">
                                <button type="button" id="btnAddtarget" class="btn bg-gradient-primary btn-sm mb-0" onclick="window.location='Superadmin_TargetMaster.aspx'">
                                    +&nbsp; Add Target
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="">
                                <div class="col-md-12">
                                    ...
                                    <table class="table align-items-center mb-0" id="tblTargetlist">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-xxs font-weight-bolder opacity-7" style="color: black;">Role Name</th>
                                                <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2" style="color: black;">Level</th>
                                                <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2" style="color: black;">Region</th>
    ...
    <script src="AppScripts/TargetList.js"></script>

    <script>
        function goBack() {
            window.location = 'Superadmin_ConfigDashboard.aspx';
        }
    </script>
